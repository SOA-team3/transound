...
describe 'AddProject Service Integration Test' do
  ...
  describe 'Retrieve and store project' do
    ...
    it 'HAPPY: should be able to find and save remote project to database' do
      ...
      project = TranSound::Github::ProjectMapper
        .new(GITHUB_TOKEN).find(USERNAME, PROJECT_NAME)
      url_request = TranSound::Forms::NewProject.new.call(remote_url: GH_URL)

      # WHEN: the service is called with the request form object
      project_made = TranSound::Service::AddProject.new.call(url_request)
    ...
    it 'HAPPY: should find and return existing project in database' do
      ...
      url_request = TranSound::Forms::NewProject.new.call(remote_url: GH_URL)
      db_project = TranSound::Service::AddProject.new.call(url_request).value!
    ...
    it 'BAD: should gracefully fail for invalid project url' do
      ...
      url_request = TranSound::Forms::NewProject.new.call(remote_url: BAD_GH_URL)
    ...
    it 'SAD: should gracefully fail for invalid project url' do
      ...
      url_request = TranSound::Forms::NewProject.new.call(remote_url: SAD_GH_URL)
