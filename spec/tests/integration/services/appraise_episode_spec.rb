...
describe 'AppraiseProject Service Integration Test' do
  ...
  describe 'Appraise a Project' do
    ...
    it 'HAPPY: should give contributions for a folder of an existing project' do
      ...
      gh_project = TranSound::Github::ProjectMapper
        .new(GITHUB_TOKEN)
        .find(USERNAME, PROJECT_NAME)
      TranSound::Repository::For.entity(gh_project).create(gh_project)
      ...
      appraisal = TranSound::Service::AppraiseProject.new.call(
      ...
      _(folder).must_be_kind_of TranSound::Entity::FolderContributions
    ...
    it 'SAD: should not give contributions for an unwatched project' do
      ...
      result = TranSound::Service::AppraiseProject.new.call(
        watched_list: [],
        requested: request
      )
